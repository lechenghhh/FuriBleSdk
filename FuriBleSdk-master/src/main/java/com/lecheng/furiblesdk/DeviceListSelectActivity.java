...
//            startActivity(new Intent(DeviceListSelectActivity.this, BluetoothLeActivity.class)
...
//            if (device.getAddress().equals(MySP.loadData(DeviceListSelectActivity.this, "address", "") + "")) {
//                new MyToast(DeviceListSelectActivity.this, "正在尝试自动连接，请稍后", 1);
//                System.out.println("lechenghaha-getview-autoconn" + device.getAddress());
//            pd = pd.show(DeviceListSelectActivity.this, "请稍等", "正在自动连接...");
////                MySP.saveData(DeviceListSelectActivity.this, "address", "");
//            new Thread() {
//                @Override
//                public void run() {
//                    try {
...
//                                DeviceListSelectActivity.this.finish();
//                            }
//                        });
//                    } catch (Exception e) {
//                        e.printStackTrace();
